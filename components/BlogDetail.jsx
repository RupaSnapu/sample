...
//       <img src={post.image} alt={post.title} style={{ width: '100%', maxWidth: '600px', display: 'block', 
//     margin: '0 auto' }} />
//       <p className="blog-detail-content">{post.content}</p>
//       {post.description && <div className="blog-detail-description">{post.description}</div>}
//     </div>
//   );
// };
...
const BlogDetail = () => {
  ...
  if (!slug) return <p>Loading...</p>;  // router query might be empty initially
  ...
  return (
    <div className="blog-detail">
      <h2>{post.title}</h2>
      <p className="blog-detail-date">{post.date}</p>
      <img src={post.image} alt={post.title} style={{ width: '100%', maxWidth: '600px', display: 'block', margin: '0 auto' }} />
      <p className="blog-detail-content">{post.content}</p>
      {post.description && <div className="blog-detail-description">{post.description}</div>}
    </div>
  );
